...
#召喚
execute unless entity @s[tag=PlacedHere] run summon chest_minecart ~ ~ ~ {CustomName:{"text":"Carpentry Table"},CustomNameVisible:1b,DisplayOffset:4,Tags:["9977CarpentryTable","9977sGUI"],NoGravity:1b,Silent:1b,Invulnerable:1b,DisplayState:{Name:"minecraft:crafting_table"}}
